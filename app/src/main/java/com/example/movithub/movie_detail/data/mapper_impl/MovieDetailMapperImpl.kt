...
import com.example.movithub.movie_detail.data.remote.models.CastDto
import com.example.movithub.movie_detail.data.remote.models.MovieDetailDto
import com.example.movithub.movie_detail.domain.models.Cast
import com.example.movithub.movie_detail.domain.models.MovieDetail
import com.example.movithub.movie_detail.domain.models.Review
...
class MovieDetailMapperImpl : ApiMapper<MovieDetail, MovieDetailDto> {
    ...
    override fun mapToDomain(apiDto: MovieDetailDto): MovieDetail {
        return MovieDetail(
            ...
            id = apiDto.id ?: 0,
            originalLanguage = formatEmptyValue(apiDto.originalLanguage, default = "language"),
            originalTitle = formatEmptyValue(apiDto.originalTitle, default = "title"),
            overview = formatEmptyValue(apiDto.overview, default = "overview"),
            popularity = apiDto.popularity ?: 0.0,
            posterPath = formatEmptyValue(apiDto.posterPath),
            releaseDate = formatEmptyValue(apiDto.releaseDate, default = "date"),
            title = formatEmptyValue(apiDto.title, default = "title"),
